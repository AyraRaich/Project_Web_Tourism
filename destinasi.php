            ...
            <div class="item active">
              ...
              <div class="carousel-caption">
                <h2 style="color: white;">DESA WISATA</h2>
                        ...
                        <center>
                        <div class="row">
                        <form action="destinasi.php" method="post" class="subscribe-form">
					...
					?>
                        ...
                        <div class="post-masonry col-md-4 col-sm-6">
                            <div class="post-thumb">
                                <img src="admin\<?php echo $data['gambar'];?>" class="img-rounded" height="250" width="250" style="border: 2px solid #000;" />
