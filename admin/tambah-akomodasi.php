    ...
    <div class="content-wrapper py-3">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Input Data Akomodasi</li>
            </ol>
                         ...
                         <div class="form">
						  ...
						  <!-- Fungsi Form Tambah Data Kasir -->
                            <div class="panel-body">
                              <div class="form">
                                  <form class="form-horizontal style-form" action="insert-akomodasi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
								
                                      <div class="form-group ">
                                          <label for="nama_akomodasi" class="control-label col-lg-2">Nama Penginapan </label>
                                          <div class="col-lg-5">
                                              <input class="form-control" id="nama_akomodasi" type="text" name="nama_akomodasi" placeholder="Nama Penginapan..."/>
                                          </div>
                                      </div>
									  <div class="form-group">
										...
										<div class="form-group ">
                                          ...
                                          <div class="col-lg-4">
                                              <input class="form-control" id="alamat" type="text" name="alamat" placeholder="Alamat Penginapan..." />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="kontak" class="control-label col-lg-2">Kontak Penginapan </label>
                                          <div class="col-lg-4">
                                              <input class="form-control" id="kontak" type="text" name="kontak" placeholder="Kontak Penginapan..." />
                                          </div>
                                      </div>
									   <div class="form-group">
										<label class="control-label col-lg-2">Deskripsi Penginapan</label>
                                            <textarea name="editor" id="editor" class="form-control" style="width:70%"  rows="10" cols="80" placeholder="Masukkan Deskripsi Tentang Penginapan..."></textarea> 
									  </div>
                                      <div class="form-group">
										<label class="control-label">Foto Tempat Penginapan</label>
                                      ...
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              ...
                                              <a class="btn btn-default" type="button" href="akomodasi.php">Cancel</a>
                                          </div>
                                      </div>
                                  </form>
                              </div>
