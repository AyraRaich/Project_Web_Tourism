...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarExample">
           ...
           <!--     <li class="nav-item">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <form class="form-inline my-2 my-lg-0 mr-lg-2" action='produk.php' method="POST">
    ...
    <div class="content-wrapper py-3">
        ...
        <div class="container-fluid">
            ...
            <p><a class="btn btn-primary icon-btn" href="tambah-produk.php"><i class="fa fa-plus"></i> Tambah Produk	</a></p>
			
			<!-- Fungsi Menampikan Isi dari Database -->
					<?php
                    $query1="SELECT * from produk ORDER BY id DESC limit 10";
                    
					// Fungsi Search
                    if(isset($_POST['qcari'])){
	               $qcari=$_POST['qcari'];
	               $query1="SELECT * FROM  produk 
	               where produk_nama like '%$qcari%' or kategori like '%$qcari%' ";
                    }
              ...
              <div class="card-body">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
					...
					<td><center><?php echo $data['kategori']; ?></center></td><td><center><img src="<?php echo $data['produk_gambar'];?>" width="100" height="100" class="img-rounded" style="border: 3px solid #888;"/></center></td>
					<td><center><?php echo $data['qty']; ?></center></td><td><center><?php echo $data['harga']; ?></center></td>
					<td><center><div id="thanks"><a class="btn btn-sm btn-info" data-placement="bottom" data-toggle="tooltip" title="Edit Produk" href="edit-produk.php?hal=edit&kd=<?php echo $data['id'];?>"><span class="fa fa-pencil"> Edit</span></a>  
                        <a onclick="return confirm ('Yakin hapus <?php echo $data['produk_nama'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Produk" href="hapus-wisata.php?hal=hapus&kd=<?php echo $data['id'];?>"><span class="fa fa-trash-o"> Delete</span></a></center></td></tr></div>
