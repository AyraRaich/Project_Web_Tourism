              ...
              <div class="card-body">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
					...
					<td><center><strong><?php echo $data['email']; ?></strong></center></td>
					<td><center><strong><?php echo $data['phone']; ?></strong></center></td>
					
					 <td><center><div id="thanks"><a class="btn btn-sm btn-info" data-placement="bottom" data-toggle="tooltip" title="Edit User" href="edit-user.php?hal=edit&kd=<?php echo $data['id'];?>"><span class="fa fa-pencil"> Edit</span></a>  
                        <a onclick="return confirm ('Yakin hapus <?php echo $data['username'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus User" href="hapus-user.php?hal=hapus&kd=<?php echo $data['id'];?>"><span class="fa fa-trash-o"> Delete</span></a></center></td></tr></div>
                 <?php   
              } 
              ?>
