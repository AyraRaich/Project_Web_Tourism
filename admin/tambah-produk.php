                         ...
                         <div class="form">
						  ...
						  <!-- Fungsi Form Tambah Data Kasir -->
                            <div class="panel-body">
                              <div class="form">
                                  <form class="form-horizontal style-form" action="insert-produk.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
								
                                      <div class="form-group ">
                                          <label for="produk_nama" class="control-label col-lg-2">Nama Produk </label>
                                          <div class="col-lg-5">
                                              <input class="form-control" id="produk_nama" type="text" name="produk_nama" placeholder="Nama Produk..."/>
                                          </div>
                                      </div>
									  <div class="form-group">
											  <label class="control-label col-lg-2" for="select">Kategori Produk</label>
												<select name="kategori" style="width:30%" class="form-control" required>
												  ...
												  <option value="Kerajinan">Kerajianan</option>
												</select>
										</div>
										<div class="form-group ">
                                          <label for="produk_desc" class="control-label col-lg-2">Produk Detail</label>
                                          <div class="col-lg-4">
                                              <textarea class="form-control" id="produk_desc"  style="width:70%"  rows="10" cols="80" type="text" name="produk_desc" placeholder="Isikan Detail Produk..." ></textarea>
                                          </div>
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-5">
                                              <input class="form-control" id="qty" name="qty" placeholder="Banyak Produk..."/>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="qty" class="control-label col-lg-2">Harga</label>
                                          <div class="col-lg-5">
                                              <input class="form-control" id="harga" name="harga" placeholder="Harga Produk..."/>
                                          </div>
                                      </div>
                                      <div class="form-group">
