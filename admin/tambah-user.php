					...
					<?php
						if(isset($_POST['input'])){
							...
							if(mysqli_num_rows($cek) == 0){
									$insert = mysqli_query($koneksi, "INSERT INTO users (username, password, email, address, phone, type)
									VALUES('$username', '$password', '$email', '$address', '$phone', '$type')");
									if($insert){
                              ...
                              <div class="form">
                                  <form class="form-horizontal style-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
									...
									<div class="form-group ">
                                          ...
                                          <div class="col-lg-2">
                                              <input class="form-control" id="phone" name="phone" type="text" onkeypress='return isNumberKeyTrue(event)' maxlength=12 /></div>
                                      </div>
                                      <div class="form-group">
