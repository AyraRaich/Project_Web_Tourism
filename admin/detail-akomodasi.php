    ...
    <div class="content-wrapper py-3">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Detail Data Akomodasi</li>
            </ol>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="form-panel">
                      ...
                      <td><span class="label label-default"><?php echo $data['nama_akomodasi']; ?></span></td>
                      <td rowspan="5"><div class="pull-right image">
                       <img src="<?php echo $data['foto_lokasi']; ?>" class="img-rounded" height="500" width="600" alt="User Image" style="border: 2px solid #000;" />
                        </div></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                      <td><strong>Lokasi Penginapan</strong></td>
                      <td colspan="1"><?php echo $data['alamat']; ?></td>
                      </tr>
                      <tr>
                      <td><strong>Deskripsi</strong></td>
                      <td colspan="1"><?php echo htmlspecialchars_decode($data['deskripsi_akomodasi']); ?></td>
                      </tr>
                      </table>
                      <div class="text-right">
                  <a href="akomodasi.php" class="btn btn-sm btn-primary">Kembali <i class="fa fa-arrow-circle-right"></i></a>
